...
//                System.out.println("line is "+outputCapture.getLine(2));
                ...
                if (outputCapture.getFirstLine().equals("asking command"))  {
                    ...
                    if (gameRunner.canFindHubi())   {
                        mapGUI.textDisplay.displayMessage("Enter the Hubi Phase",30, 0.2f*mapGUI.getScreenWidth(), 0, 0.5f*mapGUI.getScreenWidth(), 0.25f*mapGUI.getScreenHeight());
                ...
                if (TurnCount>= gameRunner.getHubiMoveThreshold())  {
//                    System.out.println("Hubi move threshold is "+gameRunner.getHubiMoveThreshold());
                    if(gameRunner.game.getPhase() == 1){
                        mapGUI.textDisplay.displayMessage("Oops, Hubi moves to another room...",30, 0.2f*mapGUI.getScreenWidth(), 0, 0.5f*mapGUI.getScreenWidth(), 0.25f*mapGUI.getScreenHeight());
                    }
