 ...
 * Date: 12/12/2024
 * Final Complete Date: 12/12/2024
 * Description: auxiliary function for supporting other java files
 * Status: Accepted
 * Method: No specified method
 */
package Schanppt_Hubi.Structure.Logic.auxiliary;
