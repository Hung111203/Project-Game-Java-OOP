...
public class GameScreen2 implements Screen {
    ...
    public GameScreen2(final Main game, final flow gameFlow) {
        this.game = game;
        ...
        logoImage = new Image(new Texture("logo3.png"));
...
//                gameFlow.startBackendflow();
                gameFlow.getGameRunner().setUpNumber_Level();
                gameFlow.startFrontendThread(game);
                gameFlow.startBackendflow();
                clickSound.play();
            }
